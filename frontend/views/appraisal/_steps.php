...
<div class="breadcrumbb flat">
        ...
        <a href="<?=  Yii::$app->recruitment->absoluteUrl() .'appraisal/view?Employee_No='.$model->Employee_No.'&Appraisal_No='.$model->Appraisal_No ?>" <?= ($model->Goal_Setting_Status == 'Approved' && $model->MY_Appraisal_Status == 'Appraisee_Level')?'class="active"': '' ?>>Mid Year Appraisal</a>
