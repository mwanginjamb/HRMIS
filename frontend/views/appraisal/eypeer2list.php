...
$this->title = 'HRMIS - AAS End Year Appraisal List: Peer 2';
$this->params['breadcrumbs'][] = ['label' => 'Performance Management', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => 'End Year Appraisal List (Peer 2)', 'url' => ['index']];
?>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">End Year Appraisal List (Peer 2)</h3>
                </div>
                <div class="card-body">
        ...
        var absolute = $('input[name=absolute]').val();
         ...
         $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#appraisal').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'appraisal/geteypeer2list',
            paging: true,
            columns: [
