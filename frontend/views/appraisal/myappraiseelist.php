...
$this->title = 'HRMIS - AAS Mid Year Appraisal List: Appraisee';
$this->params['breadcrumbs'][] = ['label' => 'Performance Management', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => 'Mid Year Appraisal List (Appraisee)', 'url' => ['index']];
?>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Mid Year Appraisal List (Appraisee)</h3>
                </div>
                <div class="card-body">
        ...
        var absolute = $('input[name=absolute]').val();
         ...
         $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#appraisal').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'appraisal/getmyappraiseelist',
            paging: true,
            columns: [
