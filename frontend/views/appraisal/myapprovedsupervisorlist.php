...
$this->title = 'HRMIS - AAS Approved Mid Year Appraisal List: Supervisor';
$this->params['breadcrumbs'][] = ['label' => 'Performance Management', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => 'Approved Mid Year Appraisal List (Supervisor)', 'url' => ['index']];
?>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Approved Mid Year Appraisal List (Supervisor)</h3>
                </div>
                <div class="card-body">
        ...
        var absolute = $('input[name=absolute]').val();
         ...
         $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#appraisal').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'appraisal/getmyapprovedsupervisorlist',
            paging: true,
            columns: [
